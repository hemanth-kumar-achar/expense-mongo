package com.myLearning.mongodblearning.config;

import com.github.cloudyrock.mongock.ChangeLog;
import com.github.cloudyrock.mongock.ChangeSet;
import com.myLearning.mongodblearning.model.Expense;
import com.myLearning.mongodblearning.model.ExpenseCategory;
import com.myLearning.mongodblearning.repository.ExpenseRepository;

import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

import static com.myLearning.mongodblearning.model.ExpenseCategory.*;

@ChangeLog
public class DatabaseChangeLog {
    @ChangeSet(order = "001", id = "seedDatabase", author = "Hemanth")
